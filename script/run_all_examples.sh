...
HOST_BIN_PATH=target/release/dvt_prover_host 

$HOST_BIN_PATH execute --type bad-share -i $REPO_ROOT/examples/dvt_bad_share.json  --show-report --json-schema-file $REPO_ROOT/spec/share_exchange_spec.json
